...
namespace utils::math {
    ...
    bool Equals(const glm::vec3& a, const glm::vec3& b, float epsilon) {
    ...
    bool Equals(const glm::quat& a, const glm::quat& b, float epsilon) {
    ...
    glm::vec2 Lerp(const glm::vec2& a, const glm::vec2& b, float t) { return glm::lerp(a, b, t); }
    glm::vec3 Lerp(const glm::vec3& a, const glm::vec3& b, float t) { return glm::lerp(a, b, t); }
    glm::vec4 Lerp(const glm::vec4& a, const glm::vec4& b, float t) { return glm::lerp(a, b, t); }
    ...
    glm::vec3 HSV2RGB(float h, float s, float v) {
        if (s <= std::numeric_limits<float>::epsilon()) {
            return glm::vec3(v);  // zero saturation = grayscale color
        }
