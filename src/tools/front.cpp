...
int main()
{
    ...
    Shader shader=ResourceManager::load_shader("../resource/shader/front.vs", "../resource/shader/front.fs", "front");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        RenderText(shader, L"我苏联", 25.0f, 25.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f));
