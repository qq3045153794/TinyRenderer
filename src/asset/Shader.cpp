...
void Shader::bind() const {
  if (g_cur_bound_program != m_id) {
    glUseProgram(m_id);
    g_cur_bound_program = m_id;
  }
}
...
INSTANTIATE_TEMPLATE(glm::vec2)
INSTANTIATE_TEMPLATE(glm::vec3)
INSTANTIATE_TEMPLATE(glm::vec4)
INSTANTIATE_TEMPLATE(glm::mat2)
INSTANTIATE_TEMPLATE(glm::mat3)
INSTANTIATE_TEMPLATE(glm::mat4)
