...
Trangle* trangle;
void init() {
  Shader shander_trangle = ResourceManager::load_shader("../resource/shader/trangle.vs", "../resource/shader/trangle.fs","trangle");
  Texture2D texture_2d_trangle = ResourceManager::load_texture("../resource/texture/awesomeface.png", "trangle");
