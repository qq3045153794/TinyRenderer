...
void init() {
  ...
  model = new gl_animation::Model("../resource/dae/Only_Spider_with_Animations_Export.dae","false");
  animation = new gl_animation::Animation("../resource/dae/Only_Spider_with_Animations_Export.dae", model);
