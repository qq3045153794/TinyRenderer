...
void TrackBallInteractor::computeCameraUp(glm::vec3& up) { up = glm::normalize(mRotationSum * Y); }
...
void TrackBallInteractor::computeRotationBetweenVectors(const glm::vec3& u, const glm::vec3& v,
                                                        glm::quat& result) {
...
Camera* TrackBallInteractor::getCamera() { return mCamera; }
...
void TrackBallInteractor::setLeftClicked(bool value) { mIsLeftClick = value; }

void TrackBallInteractor::setMiddleClicked(bool value) { mIsMiddleClick = value; }
...
void TrackBallInteractor::setMotionScroll(CameraMotionType motion) { mCameraMotionScroll = motion; }

void TrackBallInteractor::setRightClicked(bool value) { mIsRightClick = value; }
...
void TrackBallInteractor::setSpeed(float s) { mSpeed = s; }
